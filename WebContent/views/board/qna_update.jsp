...
<!-- 20210831 위재림 HTML Q&A 1:1문의 글쓰기 작업 START  -->
                        ...
                        <div class="board_write">
                            ...
                            <div class="title">
                                <dl>
                                    ...
                                    <dd><input type="text" name="bTitle" id="textbox" placeholder="문의제목을 입력해주세요." value="${board.bTitle}" readonly></dd>
                                </dl>
                            </div>
                              <!--작성자-->
                            <div class="info_user">
                                <dl>
                                    ...
                                    <dd class ="abc"><input type="text" name="MID" id="textbox"  value ="${board.MID}" readonly></dd>
                                </dl>
                            </div>
                              <!--비밀번호-->
                            <div class="info_userpw">
                                <dl>
                                    ...
                                    <dd><input type="password" name="bPassword" id="textbox" value= "${board.bpassword}" ></dd>
                                </dl>
                            </div>
                              <!--문의내용-->
                            <div class="cont">
                               ...
                               <dd> <textarea placeholder="문의내용을 입력해주세요." name="bContent">${board.bContent}</textarea></dd>
                            </dl>
                            </div>
                              <!--첨부파일-->
                           ...
                           <div class="filebox">
						    <input class="upload-name" value="${board.pictureurl}">
                          ...
                          <!--문의 등록 및 버튼-->
                         <div class="bt_wrap">
                            <input type="button" value="취소" id = "list-btn"
                            onclick="location.href='Ot4zoServlet?command=board_list'">
                        	<input type="submit" value="수정하기" id = "inquiry-btn" onclick="return boardCheck()">
                        </div>
                    </div>
                    </form>
                </div>
	...
	<jsp:include page="../common/footer_login.jsp" />
