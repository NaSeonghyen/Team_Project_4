	...
	<section>
             			...
             			<div class="board_table_body">
                			<div class="item">
                  				...
                  				<div class="tit">
                  					...
                  					<a href="Ot4zoServlet?command=notice_view&nId=${ndvo.nId}&page=${nSearchDvo.currentPageNum }&pageDataCount=${nSearchDvo.pageDataCount}&f=${param.f}&keyword=${param.keyword}">${ndvo.nTitle}</a>
                  				</div>                 		
		...
		<div class="page-list">
			<ul>
				...
				<li> 
					<a href ="Ot4zoServlet?command=notice_search&page=${nSearchDvo.prevPageNum }&pageDataCount=${nSearchDvo.pageDataCount}" class="button prev">&lt;</a>
				</li>
				<c:forEach var="i" begin="${nSearchDvo.startPageNum }"end="${nSearchDvo.endPageNum }" step="1">
					<c:choose>
						<c:when test="${i eq nSearchDvo.currentPageNum }">
							<li> <a href ="Ot4zoServlet?command=notice_search&page=${i }&pageDataCount=${nSearchDvo.pageDataCount}&f=${param.f}&keyword=${param.keyword}" class="btn num">${i}  </a> </li>
						</c:when>
						<c:otherwise>
							<li> <a href ="Ot4zoServlet?command=notice_search&page=${i }&pageDataCount=${nSearchDvo.pageDataCount}&f=${param.f}&keyword=${param.keyword}" class="btn num">${i} </a> </li>    
						</c:otherwise>
				...
				<li> <a href ="Ot4zoServlet?command=notice_search&page=${nSearchDvo.nextPageNum }&pageDataCount=${nSearchDvo.pageDataCount}" class="button next">&gt;</a></li>
				<li> <a href ="Ot4zoServlet?command=notice_search&page=${nSearchDvo.lastPageNum }&pageDataCount=${nSearchDvo.pageDataCount}" class="button last">&gt;&gt;</a></li>
			</ul>
		</div>
	</section>
	<!-- Footer  -->
