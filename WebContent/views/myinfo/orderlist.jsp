					...
					<c:forEach items="${orderList}"  var="orderVO">
						<tr>
					        ...
					        <td class= "order_product">
					          	<strong>
					          		<a href ="Ot4zoServlet?command=order_detail&oseq=${orderVO.oseq}&quantity=0" id="order_leftname">${orderVO.pname}</a>
					          	</strong>
					        </td>
				            <!--수량 -->
				            ...
				            <!--가격  -->
				            <td><fmt:formatNumber type="currency" value="${orderVO.product_price}" /></td>
						</tr>
			        </c:forEach>
		        </tbody>
			</table>
